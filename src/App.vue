    ...
    data() {
        return {
            ...
            menu : [
                ...
                {
                    label: 'Gestión Productos', icon: 'pi pi-fw pi-search',
                    items: [
                        {
                            label: 'Categoria', icon: 'pi pi-fw pi-bookmark',
                            items: [
                                {label: 'Nueva Categoria', icon: 'pi pi-fw pi-bookmark', to: '/admin/categoria/nuevo'},
                                {label: 'Lista Categoria', icon: 'pi pi-fw pi-circle-off', to: '/admin/categoria'},
                            ]
                        },
